...
Tags: Inpost, DPD, Omniva, Unisend, Packeta
...
16. DPD (Lithuania/Latvia/Estonia)
...
23. Omniva (Lithuania/Latvia/Estonia)
...
3. LP Express (Lithuania)

4. Omniva (Lithuania, Latvia, Estonia)

5. Unisend

6. Venipak (Lithuania, Latvia, Estonia)

7. Itella (Finland, Lithuania, Latvia, Estonia)

8. Posti (Finland, Lithuania, Latvia, Estonia)

9. SmartPOST by Itella (Finland, Estonia)

10. DPD (Lithuania, Latvia, Estonia)

11. Latvian post (Latvia, Lithuania)

12. Zipas Go (Lithuania, Latvia, Estonia, Poland)
...
== Changelog ==
= 1.30.30 – 2026-07-07Fixed version validation= 1.30.29 – 2026-07-01Improved shipping label access control and download link validation.
= 1.30.28 – 2026-06-25
Added support for real-time courier price calculation in WooCommerce checkout.
When enabled, the plugin sends the customer address, sender address, cart weight, parcel dimensions and product data to Noparcels and displays live courier prices returned by the API.
...
= 1.30.24 – 2026-06-11
Shipment automation fix
Latvian post location fix
...
= 1.30.21 – 2026-05-15
Storage fixes and autofill checkout fixes

= 1.30.20 – 2026-04-28
Fix LP Express storage and Apple Pay fixes

= 1.30.19 – 2026-03-31
Fix with saving selected pickup point on reload

= 1.30.18 – 2026-02-18
Safari fixes

= 1.30.17 – 2026-01-28
Fix free shipping and mass shipping

= 1.30.16 – 2026-01-27
– Fix with siuntos autobusais, add setting to show pickup point notices or no, change the action for classic checkout to display pickup points select, fix with variable products

= 1.30.15 – 2025-12-21
– Fix with classic select

= 1.30.14 - 2025-12-18
- Cached js file fix

= 1.30.13 - 2025-12-17
- Fix with group by city and select rewrite, Fix with security

= 1.30.12 - 2025-10-23
- Fix with pickup points full name
...
= 1.30.9 - 2025-10-18
- Fixes with billing state, order create

= 1.30.8 - 2025-10-16
- Fix with pickup points select

= 1.30.7 - 2025-10-09
- HPOS compatibility

= 1.30.6 - 2025-10-08
- Fix with checkout blocks country change, fixes with select and fixes with smartposti

= 1.30.5 - 2025-09-30
- Package sizes fixes

= 1.30.4 - 2025-09-17
- Images restore, fixes with labels folder, theme divi fixes

= 1.30.3 - 2025-09-12
- Images restore

= 1.30.2 - 2025-09-11
- Fix with locations, fix with newest woocommerce

= 1.30.1 - 2025-09-05
- Fixes with COD

= 1.30.0 - 2025-08-27
- Switch to Noparcels API

= 1.20.5 - 2025-07-31
- Fixes with WooPayments

= 1.20.4 - 2025-07-30
- Fixes with WooPayments compatible

= 1.20.3 - 2025-07-01
- Fix security for labels

= 1.20.2 - 2025-06-25
- Fix with Latvijas Pasts and siuntos autobusais validation

= 1.20.1 - 2025-06-02
- Fix with Latvijas Pasts

= 1.20.0 - 2025-05-14
- Fix with siuntos autobusais for old checkout. Fix with bundle products

= 1.19.9 - 2025-05-07
- Fix with cron and Latvijas Pasts

= 1.19.8 - 2025-04-10
- Fix with siuntos autobusais courier and pickup locations

= 1.19.7 - 2024-12-04
- Fix with getting new api key

= 1.19.6 - 2024-11-20
- Fix with security check, fixes wit order tracking link
